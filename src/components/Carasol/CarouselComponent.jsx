    ...
    return (
        <Carousel>
            <div className='carouselimages mt-28 mr-14 ml-14'>
                <img src="pics/curd.png" alt="To Do List App" />
                <p className="legend">
                    To Do List <br />
            ...
            <div className='carouselimages mt-28 mr-14 ml-14'>
                <img src="pics/chat app.png" alt="Chat App" />
                <p className="legend">
                    Chat App <br />
                    <strong>Languages Used</strong> <br />
                    HTML: Structure <br />
            ...
            <div className='carouselimages mt-28 mr-14 ml-14'>
                <img src="pics/doctor app.png" alt="Doctor App" />
                <p className="legend">
                    Doctor App <br />
                    <strong>Languages Used</strong> <br />
                    HTML: Structure <br />
            ...
            <div className='carouselimages mt-28 mr-14 ml-14'>
                <img src="pics/ecomm.jpg" alt="E-Commerce App" />
                <p className="legend">
                    E-commerce <br />
                    <strong>Languages Used</strong> <br />
                    HTML: Structure <br />
